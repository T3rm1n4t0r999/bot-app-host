...
class KeyboardFactory {
     ...
     * @returns {InlineKeyboard}
     */
    static createCoursesKeyboard(courses = [], currentPage = 1, totalItems, itemsPerPage = 4) {
        const keyboard = new InlineKeyboard();
     ...
     */
    static createModulesKeyboard(modules = [], courseId, currentPage = 1, totalItems, itemsPerPage = 4) {
        const keyboard = new InlineKeyboard();
        const totalPages = Math.ceil(totalItems / itemsPerPage);
